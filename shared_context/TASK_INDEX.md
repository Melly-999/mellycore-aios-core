...
| `MELLYCORE-TASK-INDEX-001` | M1 | `COMPLETE` (this task; local, isolated worktree, not pushed) | This materialization. Evidence: this file, `RUN_QUEUE.md`, `docs/tasks/MELLYCORE-TASK-INDEX-001.md`. |
...
| `MELLYCORE-M2-SHOWCASE-ACCEPTANCE-001` | M2 | `COMPLETE` (final independent rerun `MELLYCORE-M2-SHOWCASE-ACCEPTANCE-003`; local, not pushed) — `ACCEPTED_WITH_NON_BLOCKING_LIMITATIONS` | Formal acceptance chain completed at candidate `8264d29712396fa71101aedb578f5d5a13f33d8d`; M2 is complete and `SHOWCASE_READY = YES` for the local candidate lineage. Evidence: `docs/tasks/MELLYCORE-M2-SHOWCASE-ACCEPTANCE-003.md`. This does not authorize push, merge, deploy, provider/runtime activation, or public release. |
