...
| `MELLYCORE-M2-SHOWCASE-ACCEPTANCE-001` | M2 | `COMPLETE` (final independent rerun `MELLYCORE-M2-SHOWCASE-ACCEPTANCE-003`; included in pushed PR #36 lineage) — `ACCEPTED_WITH_NON_BLOCKING_LIMITATIONS` | Formal acceptance chain completed at candidate `8264d29712396fa71101aedb578f5d5a13f33d8d`; M2 is complete and `SHOWCASE_READY = YES`. Accepted release SHA `a71846f1800b921b509995ac2b65b317fcf290bf` is pushed on `review/mellycore-m2-showcase-acceptance-003`; PR #36 is open. This does not authorize merge, deployment, provider/runtime activation, or public release. |
| `MELLYCORE-M2-PUBLIC-SHOWCASE-RELEASE-001` | M2 | `COMPLETE` (authorized push and PR creation only) | Pushed exact accepted release SHA `a71846f1800b921b509995ac2b65b317fcf290bf` and opened non-draft PR #36. Merge, Production publication, and Production verification were not performed or authorized; `PUBLIC_SHOWCASE = NOT_RELEASED` for this M2 release. |
| `MELLYCORE-PR36-COMPOSED-INTEGRATION-REVIEW-001` | M2 release gate | `COMPLETE` — `NEEDS_REMEDIATION` | Full 63-commit / 110-file review found `PR36-INT-001`, P1 living canonical-state truth drift. PR #36 remains open and unmerged. |
| `MELLYCORE-PR36-COMPOSED-INTEGRATION-REMEDIATION-001` | M2 release gate | `COMPLETE` (local governance-only commit; not pushed) | Reconciles current push/PR/release truth and pointer semantics without changing `site/**`, runtime/provider code, Product Vision, or Roadmap definitions. Evidence: `docs/tasks/MELLYCORE-PR36-COMPOSED-INTEGRATION-REMEDIATION-001.md`. |
| `MELLYCORE-PR36-COMPOSED-INTEGRATION-REMEDIATION-REVIEW-001` | M2 release gate | `ELIGIBLE` — next task | Independent review of the exact local remediation commit. Production-impacting merge remains blocked pending this review and a later exact-head Operator authorization. |
...
- **IMPLEMENTATION / M2 RELEASE** — M2 implementation and Showcase Acceptance are complete. Exact accepted release SHA `a71846f1800b921b509995ac2b65b317fcf290bf` is pushed and PR #36 is open. The next M2/public-release lane task is `MELLYCORE-PR36-COMPOSED-INTEGRATION-REMEDIATION-REVIEW-001`; merge and public Production publication remain blocked and unauthorized.
