...
| `MELLYCORE-FRAMEWORK-BRIDGE-CONTRACT-SPEC-REVIEW-001` | `ELIGIBLE` | Exact next task: independent, read-only review of the Framework Bridge Contract specification. Not started, not authorized. |
