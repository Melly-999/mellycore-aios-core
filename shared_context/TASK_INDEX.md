...
| `MELLYCORE-AGENT-RUNTIME-SCAFFOLD-SPEC-REVIEW-002` | `ELIGIBLE` | Exact next task: independent, read-only re-review of the remediated specification. Not started, not authorized. |
