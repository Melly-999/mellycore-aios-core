...
Current HEAD (before this task's commit): `e7767d9` (`docs(aios): specify provenance and sensitivity model`), on top of `befaee5` (`docs(aios): close operational trust milestone`), on top of `d59db8a` (`chore(aios): run weekly l1 pilot`)
